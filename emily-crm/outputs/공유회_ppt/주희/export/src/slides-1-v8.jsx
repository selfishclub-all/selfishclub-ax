    ...
    <div style={{ display: 'flex', gap: 80, alignItems: 'center', height: '100%' }}>
      ...
      <div style={{ flex: '0 0 480px' }}>
        ...
        display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative'
          ...
          <img src={window.__resources.emily} alt="emily" style={{ width: '100%', height: '100%', objectFit: 'cover' }}
...
<Slide theme="light" topLeft="01 · 지난 여정" topRight="EMILY · SELFISH CLUB · AAA">
    ...
    <div style={{ display: 'flex', gap: 24, justifyContent: 'center', alignItems: 'flex-start' }}>
      <ChannelCard n="01" label="알림톡" brand="kakao" src={window.__resources.ch_alimtalk} alt="알림톡" />
      <ChannelCard n="02" label="카톡 채널 친구" brand="kakao" src={window.__resources.ch_kakaoplus} alt="카톡 채널 친구" />
      <ChannelCard n="03" label="이메일" brand="gmail" src={window.__resources.ch_email} alt="이메일" />
      <ChannelCard n="04" label="인스타그램" brand="instagram" src={window.__resources.ch_insta} alt="인스타그램" />
    </div>
  </Slide>;
