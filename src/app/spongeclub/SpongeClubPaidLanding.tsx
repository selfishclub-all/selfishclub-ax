                ...
                <div className="bg-white rounded-2xl shadow-sm overflow-hidden" style={{ color: "#2D2D2D" }}>
                  ...
                  >
                    <div className="shrink-0 pt-0.5">
                      ...
                      {"date" in w && w.date && <p className="text-sm opacity-50">{w.date}</p>}
                    </div>
