...
const SPEAKERS = [
  ...
  { initial: "V", name: "비비안", avatar: "/images/speakers/비비안.png", role: "Operations · AX Design", title: "비개발자 마케터가\nAX 프로젝트 PM이 되기까지", desc: "<hl>개발 역량 없이 PM을 해온 마케터</hl>가\n어떻게 AX 프로젝트의 PM을 맡게 됐을까요.\n\n클로드 코드로 프로젝트 전체를 한눈에 관리하는\n<hl>AX 대시보드를 직접 만들고</hl>,\n방향성을 잃지 않게 잡아주는\n<hl>브레인스토밍 컴패니언을 활용</hl>해\n<hl>정보를 시각화하고 바로 의사결정</hl>할 수 있는 환경을 구축했습니다.\n\nDB 수집, 신청·결제 페이지, 회원 시스템까지 —\n<hl>개발자 없이 혼자 만든 산출물</hl>로\n실제 결제까지! 그 전체 과정을 공유합니다.", image: "/images/sessions/비비안.png", part: 3, before: "개발자·디자이너와 소통하고 조율하는 데\n프로젝트 리소스의 대부분이 들어갔다.", after: "대시보드와 브레인스토밍 컴패니언으로 방향을 잡고,\nDB 수집부터 신청·결제 페이지까지 혼자 만들어\n실제 결제가 일어나는 서비스를 운영하고 있다." },
