  ...
  children: [
      ...
      children: [
        {
          ...
          children: [
            { id: "sharing-slug", path: "/sharing/[slug]", name: "공유회 상세", phase: 2, status: "in-progress", isDynamic: true, agenticNote: "🧠 커리큘럼·FAQ·리뷰 자동 파싱.", features: [{ name: "커리큘럼 섹션", done: true, phase: 1 }, { name: "FAQ 섹션", done: true, phase: 1 }, { name: "리뷰/후기", done: true, phase: 1 }, { name: "결제 버튼 (포트원)", done: true, phase: 1 }, { name: "모바일 결제 실패 버그 수정", done: true, phase: 1 }, { name: "결제 시각 KST 저장", done: true, phase: 1 }, { name: "VOD 구매 섹션 (해당 프로그램 영상)", done: false, phase: 2 }] },
        ...
        { id: "membership", path: "/membership", name: "이기적 멤버십 가입", phase: 1, status: "in-progress", agenticNote: "최우선 작업. 멤버십 혜택 소개 + 가입 CTA. 배너를 통해 진입.", features: [{ name: "멤버십 혜택 소개 랜딩", done: false, phase: 1 }, { name: "가입 CTA 버튼", done: false, phase: 1 }, { name: "가입 완료 처리 (DB 저장)", done: false, phase: 1 }] },
      ],
    },
    // ── 3. 스폰지클럽 ──
    {
    ...
    // ── 7. My Page ──
    {
      ...
      features: [
        ...
        { name: "구글 로그인 (카카오 미보유 사용자)", done: false, phase: 1 },
...
export const adminRoot: SitemapNode = {
  ...
  children: [
    ...
    { id: "admin-blog", path: "/admin/blog", name: "블로그 관리", phase: 2, status: "done", agenticNote: "🤖 에디터+업로드+미리보기.", features: [{ name: "마크다운 에디터", done: true, phase: 1 }, { name: "이미지 업로드 (Cloudflare R2)", done: true, phase: 1 }, { name: "카테고리/태그 관리", done: false, phase: 2 }, { name: "🤖 블로그 초안 작성 보조 (주제→초안)", done: false, phase: 3 }] },
...
export const securityRoot: SitemapNode = {
  ...
  phase: 1,
  status: "in-progress",
  agenticNote: "SEO 우선 작업. Webflow → 새 플랫폼 도메인 전환 시 SEO 보존 + 보안 점검.",
  features: [
    { name: "Webflow 전체 URL 매핑 (sitemap 기반)", done: false, phase: 1 },
    { name: "URL 301 리다이렉트 처리", done: true, phase: 1 },
    { name: "Webflow → 새 플랫폼 리다이렉트 추가 매핑", done: false, phase: 1 },
    { name: "sitemap.xml 자동 생성", done: false, phase: 1 },
    { name: "robots.txt 설정", done: false, phase: 1 },
    { name: "페이지별 OG 태그 (title, description, image)", done: false, phase: 1 },
    { name: "Google Search Console 설정 + sitemap 제출", done: false, phase: 1 },
    ...
    { name: "[테스트] 301 리다이렉트 동작 확인", done: false, phase: 1 },
    { name: "[테스트] sitemap.xml / OG 태그 검증", done: false, phase: 1 },
