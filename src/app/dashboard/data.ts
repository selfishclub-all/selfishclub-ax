...
export const phases: PhaseInfo[] = [
  {
    ...
    tasks: [
      ...
      { id: "1-13", title: "CRM 개선하기 (알림톡 3종 + 뉴스레터 폼 + 자동 발송)", status: "todo", phase: 1, category: "crm", page: "/admin" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "3-1l", title: "스폰지클럽 랜딩 전면 재구성 (최종 기획안 반영)", status: "done", phase: 3, category: "design", page: "/spongeclub" },
...
export const crmAgents: CrmAgent[] = [
  {
    id: "crm-1",
    name: "CRM 개선하기",
    description: "알림톡 3종(오픈/라이브/VOD) + 뉴스레터 폼 교체 + 자동 발송 + n8n 웹훅 연동",
    status: "not-started",
  },
];
