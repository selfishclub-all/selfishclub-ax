...
export const phases: PhaseInfo[] = [
  {
    ...
    tasks: [
      ...
      { id: "1-8", title: "마이페이지 구현", status: "todo", phase: 1, category: "setup", page: "/mypage" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "2-0g", title: "Webflow CMS API 콘텐츠 추출 파이프라인", status: "in-progress", phase: 2, category: "content" },
      { id: "2-1", title: "공유회 상세 콘텐츠 마이그레이션 (82개)", status: "in-progress", phase: 2, category: "content", page: "/sharing" },
