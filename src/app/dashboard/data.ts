...
export const sitemap: SitemapPage[] = [
  ...
  },
  {
    ...
    phase: 2,
    children: [
      { path: "/sharing/[slug]", name: "공유회 상세", auth: "none", status: "not-started", phase: 2 },
    ],
  },
  {
    path: "/challenge",
    ...
    phase: 2,
    children: [
      { path: "/challenge/[slug]", name: "챌린지 상세", auth: "none", status: "not-started", phase: 2 },
    ],
  },
  {
    path: "/selfishcrew",
  ...
  },
  {
    ...
    phase: 2,
    children: [
      { path: "/blog/[slug]", name: "블로그 상세", auth: "none", status: "not-started", phase: 2 },
    ],
  },
  {
    path: "/portfolio",
...
export const phases: PhaseInfo[] = [
  {
    ...
    tasks: [
      ...
      { id: "1-9", title: "마이페이지 NaN원 버그", status: "todo", phase: 1, category: "setup", page: "/mypage" },
      ...
      { id: "1-11", title: "포트원 결제 재연동", status: "todo", phase: 1, category: "payment", page: "/membership" },
      ...
      { id: "1-16", title: "어드민 v1 — 프로그램 등록/수정", status: "todo", phase: 1, category: "admin", page: "/admin" },
  ...
  },
  {
    ...
    tasks: [
      { id: "2-1", title: "공유회 30개+ 마이그레이션", status: "todo", phase: 2, category: "content", page: "/sharing" },
      { id: "2-2", title: "챌린지 마이그레이션", status: "todo", phase: 2, category: "content", page: "/challenge" },
      { id: "2-3", title: "블로그 마이그레이션", status: "todo", phase: 2, category: "content", page: "/blog" },
      ...
      { id: "2-6", title: "추천 AI툴 페이지", status: "todo", phase: 2, category: "content", page: "/aitools" },
  ...
  },
  {
    ...
    tasks: [
      { id: "3-1", title: "AAA 전용 랜딩 페이지", status: "todo", phase: 3, category: "content", page: "/aaa" },
