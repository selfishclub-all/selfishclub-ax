...
export const phases: PhaseInfo[] = [
  {
    ...
    tasks: [
      ...
      { id: "1-16", title: "어드민 v1 — 프로그램 등록/수정", status: "in-progress", phase: 1, category: "admin", page: "/admin" },
  ...
  },
  {
    ...
    tasks: [
      { id: "2-1", title: "공유회 30개+ 마이그레이션", status: "in-progress", phase: 2, category: "content", page: "/sharing" },
      { id: "2-2", title: "챌린지 마이그레이션", status: "in-progress", phase: 2, category: "content", page: "/challenge" },
